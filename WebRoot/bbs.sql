...
insert  into `jbbs_bankuai`(`id`,`name`,`img`,`type`,`descs`,`parentid`,`orderby`,`createtime`,`createuserid`,`fatiegroup`,`huifugroup`,`findgroup`,`yuming`) values (1,'论坛','bankuai.jpg',NULL,'',0,1,'2017-07-26 13:44:15',1,'','','','luntan'),(2,'板块测试','bankuai.jpg',NULL,'',1,1,'2017-07-26 13:44:25',1,'','','','bankuaiceshi');
...
insert  into `jbbs_info`(`id`,`indextitle`,`name`,`keywords`,`description`,`logoimg`,`foothtml`) values (1,'国内免费开源javaee论坛源码系统','javaee论坛','javaee,开源论坛,免费论坛,javaee论坛,java论坛','国内唯一一款免费开源javaee论坛源码系统，采用springMVC+mybatis框架开发。','20170513/2017051321351528862961.PNG','');
...
insert  into `jbbs_user`(`id`,`name`,`loginname`,`pwd`,`img`,`email`,`birthday`,`sex`,`mobile`,`qianming`,`createtime`,`lastlogintime`,`zhuceip`,`loginip`,`flag`,`jifen`,`onlinetime`,`cookieid`) values (1,'超级管理员','javaee','4QrcOUm6Wau+VuBX8g+IPg==','touxiang.jpg','javaeecc@qq.com','2017-05-12','0','13911111111','签名','2017-05-06 22:25:35','2017-07-26 13:43:55','737a87b275c7477b8cebaa90b3f1d08a','10.177.10.182','1',7,240,'40814129c79f485e9b99ed763da3869a');
...
insert  into `jbbs_zhuti`(`id`,`name`,`bankuai_id`,`orderby`,`createtime`) values (1,'测试主题',2,1,'2017-07-26 13:50:27');
