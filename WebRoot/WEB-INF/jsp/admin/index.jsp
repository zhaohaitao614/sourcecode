...
<div class="leftnav">
  ...
  <h2><span  class="icon-pencil-square-o"></span>常用设置</h2>
  <ul  style="display:block">
    <li><a href="${path}/admin/link/index.do" target="right"><span class="icon-caret-right"></span>友情链接</a></li>
  </ul>  
  <h2><span  class="icon-pencil-square-o"></span>网站管理</h2>
  <ul>
    <li><a href="${path}/admin/innerlink/index.do" target="right"><span class="icon-caret-right"></span>内部链接</a></li>  
    ...
    <li><a href="${path}/admin/stopip/index.do" target="right"><span class="icon-caret-right"></span>ip设置</a></li>  
  </ul>  
