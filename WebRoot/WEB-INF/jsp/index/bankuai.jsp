   ...
   <div class="wp cl"> 
    ...
    <div class="qing_forum_second cl"> 
     ...
     <ul id="thread_types" class="qttp y cl"> 
      <li <c:if test="${zhutiid==0}">class="xw1 a"</c:if>  ><a href="${path}/${bankuai.yuming}/1_0_${orderby}.html">全部<span></span></a></li> 
      <c:forEach items="${zhutilist}" var="zhuti">
	      <li <c:if test="${zhutiid==zhuti.id}">class="xw1 a"</c:if> ><a href="${path}/${bankuai.yuming}/1_${zhuti.id}_${orderby}.html">${zhuti.name}<span></span></a></li> 
      </c:forEach>
     </ul> 
    </div> 
   </div> 
         ...
         <tbody>
          <tr> 
           <th colspan="2"> 
            <div class="tf"> 
             <div class="z"> 
              <a href="${path}/${bankuai.yuming}/1_${zhutiid}_0.html" class=""><i class="newthead"></i>最新</a>&nbsp; 
              <a href="${path}/${bankuai.yuming}/1_${zhutiid}_1.html" class=""><i class="lastthead"></i>最后回复</a>&nbsp; 
              <a href="${path}/${bankuai.yuming}/1_${zhutiid}_2.html" class=""><i class="verythead"></i>精华</a>&nbsp; 
              <a href="${path}/${bankuai.yuming}/1_${zhutiid}_3.html" class=""><i class="hotthead"></i>热门</a>&nbsp; 
             </div> 
            </div> </th> 
          </tr> 
         </tbody>
	           ...
	           <tr> 
	            ...
	            <th class="common"> 
	             ...
	             <div class="q_f_title2"> 
	              <div class="z"> 
	               <a href="${path}/member/${zhiding.tieziuserid}_1.html" style="color: #CC3333;">${zhiding.tieziusername}</a> 发表于 
