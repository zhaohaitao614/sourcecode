...
<title>${user.loginname}的主题--${applicationScope.bbsinfo.name}</title>
<meta name="keywords" content="${user.loginname}的主题" /> 
<meta name="description" content="${user.loginname}的主题" /> 
<link rel="stylesheet" type="text/css" href="${path}/css/css/style_common.css" />
<link rel="stylesheet" type="text/css" href="${path}/css/css/style_home_user.css" /> 
  ...
  <div id="wp" class="wp"> 
   <div class="qing_space_tb cl"> 
    <ul class="tb cl"> 
     ...
     <li class="a"><a href="${path}/member/${user.id}_2.html">主题</a></li> 
         ...
         <tbody>
          ...
          <c:forEach items="${tiezipage.list}" var="tiezi">
	          <tr> 
	           ...
	           <td> <a href="${path}/${tiezi.yuming}/" class="xg1" target="_blank">${tiezi.bankuainame }</a> </td> 
